...
#neutral art
os.system("querycsv.py -i WikiArtEmotionsAllEdited.csv -o neutralArt.csv \"select ImageURL, Title, Artist, Year, neutral from WikiArtEmotionsAllEdited where CAST(neutral AS float)>0.05 ORDER BY CAST(neutral AS float) DESC;\"")
print("neutral art collected")
#angry art
...
#disgust art
os.system("querycsv.py -i WikiArtEmotionsAllEdited.csv -o disgustArt.csv \"select ImageURL, Title, Artist, Year, disgust from WikiArtEmotionsAllEdited where CAST(disgust AS float)>0.3 ORDER BY CAST(disgust AS float) DESC;\"")
